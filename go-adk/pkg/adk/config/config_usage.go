...
func ValidateAgentConfigUsage(config *types.AgentConfig) error {
...
func ValidateAgentConfigUsageWithLogger(config *types.AgentConfig, logger logr.Logger) error {
	if config == nil {
...
func GetAgentConfigSummary(config *types.AgentConfig) string {
	if config == nil {
...
func getModelName(m types.Model) string {
	switch m := m.(type) {
	case *types.OpenAI:
		return m.Model
	case *types.AzureOpenAI:
		return m.Model
	case *types.Anthropic:
		return m.Model
	case *types.GeminiVertexAI:
		return m.Model
	case *types.GeminiAnthropic:
		return m.Model
	case *types.Ollama:
		return m.Model
	case *types.Gemini:
