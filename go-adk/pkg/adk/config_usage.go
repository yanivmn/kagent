...
func ValidateAgentConfigUsage(config *core.AgentConfig) error {
...
func ValidateAgentConfigUsageWithLogger(config *core.AgentConfig, logger logr.Logger) error {
	if config == nil {
...
func GetAgentConfigSummary(config *core.AgentConfig) string {
	if config == nil {
...
func getModelName(model core.Model) string {
	switch m := model.(type) {
	case *core.OpenAI:
		return m.Model
