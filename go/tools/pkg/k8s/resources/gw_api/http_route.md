...
UQ: expose the productpage service on path /productpage through the bookinfo-gateway
JSON: { "apiVersion": "gateway.networking.k8s.io/v1", "kind": "HTTPRoute", "metadata": { "name": "route" }, "spec": { "parentRefs": [ { "name": "bookinfo-gateway" } ], "rules": [ { "matches": [ { "path": { "type": "Exact", "value": "/productpage" } } ] } ] } }

UQ: split the traffic to 'reviews' service and 20% to reviews-v1 and 80% to reviews-v2
JSON: { "apiVersion": "gateway.networking.k8s.io/v1", "kind": "HTTPRoute", "metadata": { "name": "reviews" }, "spec": { "parentRefs": [ { "group": "", "kind": "Service", "name": "reviews", "port": 80 } ], "rules": [ { "backendRefs": [ { "name": "reviews-v1", "port": 80, "weight": 20 }, { "name": "reviews-v2", "port": 80, "weight": 80 } ] } ] } }

UQ: mirror traffic sent httpbin-v2 service
JSON: { "apiVersion": "gateway.networking.k8s.io/v1", "kind": "HTTPRoute", "metadata": { "name": "route" }, "spec": { "parentRefs": [ { "group": "", "kind": "Service", "name": "httpbin", "port": 8000 } ], "rules": [ { "filters": [ { "type": "RequestMirror", "requestMirror": { "backendRef": { "name": "httpbin-v2", "port": 80 } } } ], "backendRefs": [ { "name": "httpbin-v1", "port": 80 } ] } ] } }

UQ: redirect traffic from /old-url to /new-url on httpbin service and replace the matched prefix
JSON: { "apiVersion": "gateway.networking.k8s.io/v1", "kind": "HTTPRoute", "metadata": { "name": "route" }, "spec": { "parentRefs": [ { "group": "", "kind": "Service", "name": "httpbin", "port": 8000 } ], "rules": [ { "matches": [ { "path": { "type": "PathPrefix", "value": "/anything/old-url" } } ], "filters": [ { "type": "RequestRedirect", "requestRedirect": { "path": { "type": "ReplacePrefixMatch", "replacePrefixMatch": "/anything/new-url" }, "statusCode": 302 } } ] }, { "backendRefs": [ { "name": "httpbin", "port": 8000 } ] } ] } }

UQ: rewrite the path from /old-url to /new-url on httpbin service and replace the matched prefix
JSON: { "apiVersion": "gateway.networking.k8s.io/v1", "kind": "HTTPRoute", "metadata": { "name": "route" }, "spec": { "parentRefs": [ { "group": "", "kind": "Service", "name": "httpbin", "port": 8000 } ], "rules": [ { "matches": [ { "path": { "type": "PathPrefix", "value": "/old-url" } } ], "filters": [ { "type": "URLRewrite", "urlRewrite": { "hostname": "httpbin", "path": { "type": "ReplacePrefixMatch", "replacePrefixMatch": "/new-url" } } } ], "backendRefs": [ { "name": "httpbin", "port": 8000 } ] }, { "backendRefs": [ { "name": "httpbin", "port": 8000 } ] } ] } }
"""